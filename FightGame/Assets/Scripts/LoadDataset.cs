...
public class LoadDataset : MonoBehaviour
{
    ...
    public string dataSetName = "Assets/Resources/card10";  //  Assets/StreamingAssets/QCAR/DataSetName
 
    // Use this for initialization
    void Start()
    {
        augmentationObject = GameObject.Find("card10");

        // Vuforia 6.2+
        VuforiaARController.Instance.RegisterVuforiaStartedCallback(DupDataSet);
    }
